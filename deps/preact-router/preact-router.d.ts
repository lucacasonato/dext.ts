import * as preact from "../preact/preact.d.ts";
...
export class Router extends preact.Component<RouterProps, unknown> {
  ...
  render(props: RouterProps, _: unknown): preact.VNode;
}
...
type AnyComponent<Props> =
  ...
  | preact.ComponentConstructor<Props, unknown>;
